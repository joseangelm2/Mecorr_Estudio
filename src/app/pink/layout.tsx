...
export const metadata: Metadata = { title: "Mis XV — Pink", description: "Te Invito a Mi Día Más Especial" };

export default function PinkLayout({ children }: { children: React.ReactNode }) {
