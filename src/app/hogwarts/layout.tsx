...
export const metadata: Metadata = { title: "Mis XV — Hogwarts", description: "Te Invito a Mi Día Más Especial" };

export default function HogwartsLayout({ children }: { children: React.ReactNode }) {
