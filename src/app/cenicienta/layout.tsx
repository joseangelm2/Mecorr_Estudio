...
export const metadata: Metadata = { title: "Mis XV — Cenicienta", description: "Te Invito a Mi Día Más Especial" };

export default function CenicientaLayout({ children }: { children: React.ReactNode }) {
  return (
