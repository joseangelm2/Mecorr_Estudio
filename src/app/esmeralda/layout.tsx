...
import { Carattere, Bellefair, Cormorant_Garamond, Old_Standard_TT } from "next/font/google";
...
export const metadata: Metadata = { title: "Mis XV — Esmeralda", description: "Te Invito a Mi Día Más Especial" };

export default function EsmeraldaLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${carattere.variable} ${bellefair.variable} ${cormorant.variable} ${oldStandard.variable}`}>
      {children}
    </div>
  );
}
