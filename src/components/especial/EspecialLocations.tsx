...
export default function EspecialLocations({ project, decorationSrc = '/images/flores-01.png' }: Props) {
  return (
    <>
      {project.ceremony && (
        <section className="padding-section text-center" style={{ paddingBottom: '20px' }}>
          <div className="row justify-content-center">
            <div className="col-md-10">
              ...
              <p className="color-textos mb-10 wow fadeInUp" style={{ fontWeight: 600 }}>{project.ceremony.venue}</p>
              <p className="color-textos mb-10 wow fadeInUp">{project.ceremony.address}</p>
              <p className="color-textos mb-20 wow fadeInUp" style={{ fontWeight: 600 }}>{project.ceremony.time}</p>
        ...
        <section className="padding-section text-center" style={{ paddingBottom: '20px' }}>
          <div className="row justify-content-center">
            <div className="col-md-10">
              ...
              <p className="color-textos mb-10 wow fadeInUp" style={{ fontWeight: 600 }}>{project.reception.venue}</p>
              <p className="color-textos mb-10 wow fadeInUp">{project.reception.address}</p>
              <p className="color-textos mb-20 wow fadeInUp" style={{ fontWeight: 600 }}>{project.reception.time}</p>
