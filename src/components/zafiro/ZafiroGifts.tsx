    ...
    <>
      ...
      {project.show_lluvia_sobres && (
        <div className="extra show-p-y">
          <img src="/images/zafiro/sobre.png" style={{ width: "25%", filter: "var(--zafiro-dark-filter)" }} alt="Sobre" />
      ...
      {project.show_datos_bancarios && project.gift_registry?.bankAccount && (
        <div className="extra show-p-y" style={{ width: "100%" }}>
          <img src="/images/zafiro/mesa_regalos.png" style={{ width: "20%", marginBottom: "3%", filter: "var(--zafiro-dark-filter)" }} alt="Transferencia" />
      ...
      {project.dress_code && (
        <div className="extra show-p-y">
          <img src="/images/zafiro/vestimenta.png" style={{ width: "30%", marginBottom: "3%", filter: "var(--zafiro-dark-filter)" }} alt="Vestimenta" />
      ...
      <div id="whatsappLink" className="extra show-p-y">
        <img src="/images/zafiro/buzon.png" style={{ width: "25%", marginBottom: "3%", filter: "var(--zafiro-dark-filter)" }} alt="Buzón" />
