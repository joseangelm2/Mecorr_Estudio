...
export default function ZafiroLocations({ project }: Props) {
        ...
        <>
          {project.ceremony.photoUrl && (
            <img
              ...
              src={project.ceremony.photoUrl}
              style={{ marginTop: "5%", borderRadius: "2vw" }}
              alt=""
            />
          )}
          <a
            className="ubicacion show-p-y"
      ...
      {project.reception && (
        <>
          {project.reception.photoUrl && (
            <img
              className="foto-full show-p-y"
              src={project.reception.photoUrl}
              style={{ marginTop: "5%", borderRadius: "2vw" }}
              alt=""
            />
          )}
