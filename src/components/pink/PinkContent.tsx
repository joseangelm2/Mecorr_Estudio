...
function sendWhatsApp(lada: string, number: string, message: string) {
  const url = `https://api.whatsapp.com/send?phone=${lada}${number}&text=${encodeURIComponent(message)}`;
  window.open(url, "_self");
}

export default function PinkContent() {
  ...
  return (
    <div className="contenido">
      <div className="encabezado">
        <h2 className="nombre-principal" style={{ fontSize: "13vw" }}>
          Mis XV
        </h2>
      </div>

      <div className="frase">
        Hoy comienza un camino que conduce a un mundo nuevo de ilusión,
        esperanza y unos bellos sueños.
      </div>
      ...
      <div className="frase show">
        &ldquo;Porque este día es muy importante para mí, quiero compartirlo
        con las personas que llevo en mi corazón. Tú eres una de ellas.
        Quisiera que estés presente en uno de los días más inolvidables de mi
        vida.&rdquo;
      </div>
      ...
      <div className="frase show" style={{ fontSize: "5.5vw" }}>
        Celebremos juntos
      </div>
      ...
      <div className="frase show" style={{ fontStyle: "italic" }}>
        Los momentos que disfrutas con tus seres queridos se transforman en
        recuerdos imborrables que perduran eternamente...
      </div>
      ...
      <div className="itinerario show-p-y">
        ...
        <div style={{ width: "100%" }}>
          <div className="evento izquierda" style={{ marginTop: "4vw" }}>
            <div className="icono show-n-x">
              <div className="circulo">
                <img src="/images/esmeralda/iglesia.png" alt="Misa" />
              </div>
            </div>
            <div className="item show-p-x">
              <h4 className="nombre">Misa</h4>
              <p className="hora">05:00 PM</p>
            </div>
          </div>
          <div className="evento derecha">
            <div className="item show-n-x">
              <h4 className="nombre">Recepción</h4>
              <p className="hora">07:00 PM</p>
            </div>
            <div className="icono show-p-x">
              <div className="circulo">
                <img src="/images/esmeralda/recepcion.png" alt="Recepción" />
              </div>
            </div>
          </div>
          <div className="evento izquierda">
            <div className="icono show-n-x">
              <div className="circulo">
                <img src="/images/esmeralda/coctel.png" alt="Coctelería" />
              </div>
            </div>
            <div className="item show-p-x">
              <h4 className="nombre">Coctelería</h4>
              <p className="hora">08:00 PM</p>
            </div>
          </div>
          <div className="evento derecha">
            <div className="item show-n-x">
              <h4 className="nombre">Cena</h4>
              <p className="hora">09:00 PM</p>
            </div>
            <div className="icono show-p-x">
              <div className="circulo">
                <img src="/images/esmeralda/comida.png" alt="Cena" />
              </div>
            </div>
          </div>
          <div className="evento izquierda">
            <div className="icono show-n-x">
              <div className="circulo">
                <img src="/images/esmeralda/vals.png" alt="Vals" />
              </div>
            </div>
            <div className="item show-p-x">
              <h4 className="nombre">Vals</h4>
              <p className="hora">10:20 PM</p>
            </div>
          </div>
          <div className="evento derecha">
            <div className="item show-n-x">
              <h4 className="nombre">Baile</h4>
              <p className="hora">11:30 PM</p>
            </div>
            <div className="icono show-p-x">
              <div className="circulo">
                <img src="/images/esmeralda/baile.png" alt="Baile" />
              </div>
            </div>
          </div>
          <div className="evento izquierda">
            <div className="icono show-n-x">
              <div className="circulo">
                <img src="/images/esmeralda/fin.png" alt="Fin" />
              </div>
            </div>
            <div className="item show-p-x">
              <h4 className="nombre">Fin del Evento</h4>
              <p className="hora">03:00 AM</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="whatsappLink" className="extra show-p-y">
        ...
        <p className="texto" style={{ width: "90%" }}>
          Déjame un lindo mensaje por mis XV años, recibo tus palabras con cariño en este buzón:
        </p>
