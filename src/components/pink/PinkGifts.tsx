...
export default function PinkGifts({ project }: Props) {
    ...
    <>
      {project.gift_registry?.liverpoolLink && (
        <a className="extra show-p-y" href={project.gift_registry.liverpoolLink} target="_self">
          <img style={{ width: "50%", marginBottom: "3%" }} src="/images/pink/liverpool.png" alt="Liverpool" />
      ...
      {project.show_lluvia_sobres && (
        <div className="extra show-p-y">
          <img src="/images/pink/sobre.png" style={{ width: "25%" }} alt="Sobre" />
      ...
      {project.show_datos_bancarios && project.gift_registry?.bankAccount && (
        <div className="extra show-p-y" style={{ width: "100%" }}>
          <img src="/images/pink/mesa_regalos.png" style={{ width: "20%", marginBottom: "3%" }} alt="Transferencia" />
      ...
      {project.dress_code && (
        <div className="extra show-p-y">
          <img src="/images/pink/vestimenta.png" style={{ width: "30%", marginBottom: "3%" }} alt="Vestimenta" />
      ...
      <div id="whatsappLink" className="extra show-p-y">
        <img src="/images/pink/buzon.png" style={{ width: "25%", marginBottom: "3%" }} alt="Buzón" />
